...
import com.quickPay.utils.MyX509TrustManager;
...
public class RequestUtil {
	...
	public static JSONObject httpsRequest(String requestUrl,
		...
		log.info("[发起HTTPS请求  入参] url = {} param = {}",requestUrl,outputStr);
		...
		try {
			...
			throw new CommonException("HTTPS请求异常");
		}finally{
			try {
				...
				throw new CommonException("HTTPS释放资源异常");
			}
		}
		return jsonObject;
	}
